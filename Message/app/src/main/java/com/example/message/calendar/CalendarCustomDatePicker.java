...
public class CalendarCustomDatePicker implements View.OnClickListener, CalendarPickerView.OnSelectListener {
    ...
    private CalendarPickerView mDpvYear, mDpvMonth, mDpvDay, mDpvHour, mDpvMinute;
     ...
     */
    public CalendarCustomDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
        this(context, callback, CalendarDateFormatUtils.str2Long(beginDateStr, true),
                CalendarDateFormatUtils.str2Long(endDateStr, true));
    }
     ...
     */
    public CalendarCustomDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.calendar_time);
    ...
    public boolean setSelectedTime(String dateStr, boolean showAnim) {
        return canShow() && !TextUtils.isEmpty(dateStr)
                && setSelectedTime(CalendarDateFormatUtils.str2Long(dateStr, mCanShowPreciseTime), showAnim);
    }
