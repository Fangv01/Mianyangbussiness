...
public class CalendarPickerView extends View {
    ...
    private static class ScrollHandler extends Handler {
        private WeakReference<CalendarPickerView> mWeakView;

        private ScrollHandler(CalendarPickerView view) {
            mWeakView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            CalendarPickerView view = mWeakView.get();
            if (view == null) return;
